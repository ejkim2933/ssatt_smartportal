              ...
              <div className="md:col-span-2 bg-white p-6 sm:p-8 rounded-3xl border border-slate-100 shadow-sm flex items-start gap-4 sm:gap-6">
                ...
                <div className="space-y-2 text-left">
                  <p className="text-slate-800 text-xs sm:text-sm font-normal leading-relaxed whitespace-pre-line">
                    <span className="text-red-600 font-bold">[주의사항]</span>
                    {"\n\n"}
                    <span className="font-bold text-slate-900">1. 연차 발생 및 사용</span>
                    ...
                    {"\n\n"}
                    <span className="font-bold text-slate-900">2. 연차 소진시 근태 처리</span>
                    {"\n"}1) 부여된 연차를 모두 소진한 후 추가적인 휴식이 필요한 경우에도 사전에 승인을 받아야 하며 해당 일수는 <span className="text-red-600 font-bold">'무급휴무'</span> 처리됨을 알려 드립니다.
                    {"\n"}2) 근로기준법에 따라 연차 없이 무급휴무(결근) 처리되었을 경우 해당 주의 <span className="text-red-600 font-bold">'주휴수당'은 발생하지 않습니다</span>. 연차 사용 계획 시 이 점을 반드시 유념하시어 급여상의 불이익이 없도록 주의해 주시기 바랍니다.
                  </p>
                </div>
              </div>
